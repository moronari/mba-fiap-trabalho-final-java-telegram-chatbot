...
public class MenuExibicaoDadosTitular implements MenuInterface {
	...
	public void process() {
    	...
    	App.telegramBot.setUpdatesListener(new MenuExibicaoDadosTitularProcess(), new GetUpdates().limit(App.updatesLimit).offset(App.updateId));
